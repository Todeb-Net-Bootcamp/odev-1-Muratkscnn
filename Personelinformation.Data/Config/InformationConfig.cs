...
namespace Personelinformation.Data.Config
{
    class InformationConfig : IEntityTypeConfiguration<Information>
    {
        ...
        {
            builder.HasData(
            new Information { InformationID = 1, PersonelName = "Murat", PersonelSurname = "Kuşcan", DetailInformationID = 1, PersonelInformationID = 1 },
               new Information { InformationID = 2, PersonelName = "Adnan", PersonelSurname = "Derkan", DetailInformationID = 2, PersonelInformationID = 2 },
               new Information { InformationID = 3, PersonelName = "Esra", PersonelSurname = "Kurt", DetailInformationID = 3, PersonelInformationID = 3 }
